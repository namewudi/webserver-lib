...
namespace net{
    ...
    public:
        ...
        static Status parseRequestLine(std::shared_ptr<base::CircleReadBuffer>& data, int begin, int end, std::shared_ptr<HttpRequest> req);
        static HttpVersion parseVersion(std::string);
        static void parseParameter(std::shared_ptr<base::CircleReadBuffer>& data, int begin, int end, std::shared_ptr<HttpRequest> req);
        ...
        static Status parseRequestBody(std::shared_ptr<base::CircleReadBuffer>& data, int begin, int end, std::shared_ptr<HttpRequest> req);
